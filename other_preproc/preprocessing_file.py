...
modification_set('../data/input/propeller/onclick_train.tsv', '../data/input/propeller/train.tsv')
modification_set('../data/input/propeller/onclick_test.tsv', '../data/input/propeller/eval.tsv')
